...
const WeatherDetailsCardSkeleton = () => {
  return (
    <div className="flex w-full justify-center rounded-2xl bg-slate-100 p-5 transition duration-200 hover:shadow-2xl dark:bg-secondary">
      <div className="w-full space-y-5">
        <div className="flex justify-between text-2xl">
          <div className="bg-tertiary h-6 w-1/3 animate-pulse rounded-md "></div>
          <div className="bg-tertiary h-6 w-1/3 animate-pulse rounded-md"></div>
        </div>
        <section className="flex justify-around">
          <div className="flex flex-col items-center">
            <div className="flex items-center">
              ...
              <div className="bg-tertiary ml-4 h-32 w-32 animate-pulse rounded-md"></div>
            </div>
          </div>
          <div className="flex flex-col text-2xl">
            <div className="mb-5 flex justify-between gap-5">
              <div className="bg-tertiary h-6 w-2/3 animate-pulse rounded-md"></div>
              <div className="bg-tertiary h-6 w-1/3 animate-pulse rounded-md"></div>
            </div>
